...
public final class Util {
	...
	public static UploadDataProgress uploadProgressFacebook;
	 ...
	 */
	public static String openUrl(int position, String url, String method, Bundle params)
 throws MalformedURLException, IOException {
		...
		if (!method.equals("GET")) {
			...
			if (!dataparams.isEmpty()) {
				...
				for (String key : dataparams.keySet()) {
					...
					writeWithProgress(position, dataparams.getByteArray(key), os);
					os.write((endLine + "--" + strBoundary + endLine).getBytes());
	...
	/**
	 * If {@link Util#uploadProgressFacebook} is not null the registered progress
	 ...
	 * @throws IOException
	 */
	private static void writeWithProgress(int position, byte[] data, OutputStream os) throws IOException {
		...
		while ((bytesRead = bis.read(buffer)) != -1) {
			...
			if (uploadProgressFacebook != null) {
				byteReadSum = byteReadSum + bytesRead;
				uploadProgressFacebook.progress(position, data.length, byteReadSum);
			}
		}
	}
}
...
// *
// * @see {@link Util#uploadProgress} to register your implementation <br/>
// * Example:
// * <p>
// * <blockquote>
// *
...
// * notification.contentView.setProgressBar(R.id.status_progress, totalBytes,
// transferedBytes, false);
